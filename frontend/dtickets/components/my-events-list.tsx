  ...
  return [
    {
      ...
      status: "upcoming",
      imageUrl: "/placeholder.svg?height=200&width=400&text=Blockchain+Summit",
    },
    {
      id: "created2",
      ...
      status: "upcoming",
      imageUrl: "/placeholder.svg?height=200&width=400&text=Gaming+Workshop",
    },
    {
      id: "created3",
  ...
  return (
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        <Card className="bg-ocean border-sea">
        ...
        {events.map(event => (
          ...
          >
            ...
            {event.imageUrl ? (
              ...
              <div className="relative w-full h-32 bg-gradient-to-br from-sea/20 via-aqua/10 to-sea/30 overflow-hidden">
                {/* Geometric pattern background */}
                <div className="absolute inset-0 opacity-20">
                  <div className="absolute top-2 left-2 w-8 h-8 border border-sea/40 rounded-full"></div>
                  <div className="absolute top-4 right-4 w-6 h-6 border border-aqua/40 rotate-45"></div>
                  <div className="absolute bottom-3 left-4 w-4 h-4 bg-sea/30 rounded-full"></div>
                  <div className="absolute bottom-4 right-3 w-3 h-3 bg-aqua/30 rotate-45"></div>
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 border border-sea/30 rounded-lg rotate-12"></div>
                </div>
                {/* Event type indicator */}
                <div className="absolute inset-0 flex items-center justify-center">
                  <Ticket className="h-8 w-8 text-sea/60" />
                </div>
            ...
            <CardHeader>
              ...
              <div className="text-aqua flex items-center text-sm">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-aqua">Tickets Sold</span>
