...
const mockEvents: Event[] = [
  ...
  },
  {
    ...
    remainingTickets: 30,
    totalTickets: 50,
    imageUrl: "/placeholder.svg?height=200&width=400&text=NFT+Art+Gala",
  },
  {
    id: "3",
    ...
    totalTickets: 500,
    imageUrl: "/placeholder.svg?height=200&width=400&text=Music+Festival",
  },
  {
    id: "4",
  ...
  },
  {
    ...
    totalTickets: 300,
    imageUrl: "/placeholder.svg?height=200&width=400&text=Gaming+Expo",
  },
  {
    id: "6",
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-grow">
          ...
          <Input
            ...
            className="pl-10 bg-ocean border-sea text-cloud focus:ring-sea w-full"
          />
        </div>
        <div className="flex gap-4">
          ...
          >
            <SelectTrigger className="w-full md:w-[180px] bg-ocean border-sea text-cloud focus:ring-sea">
