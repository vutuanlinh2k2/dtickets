...
export default function BuyTicketModal({
  ...
  const [recipientIdToUpdate, setRecipientIdToUpdate] = useState<string | null>(null)
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-deep-ocean p-4 rounded-lg border border-sea">
            ...
            <div className="flex justify-between items-center mb-2">
              ...
              <span className="text-cloud font-semibold">{ticketPrice === 0 ? "Free" : `${ticketPrice} SUI`}</span>
            </div>
            <div className="flex justify-between items-center border-t border-sea pt-2">
              ...
              <span className="text-sea font-bold text-lg">{totalCost === 0 ? "Free" : `${totalCost} SUI`}</span>
            </div>
          </div>
...
BuyTicketModal.defaultProps = {
  ...
  onPurchase: async (recipients: string[]) => {
    console.log("Purchasing tickets for:", recipients)
